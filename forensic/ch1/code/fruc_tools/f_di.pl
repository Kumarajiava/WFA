#! c:\perl\bin\perl.exe
#--------------------------------------------------------------------
# f_di.pl - Perl script to retrieve drive information
#           Allows for checking of remote hosts
#
# Usage: C:\perl>f_di.pl 
#        C:\perl>f_di.pl <host> <username> <password>
#
...
Collect drive information from remote Windows systems.
